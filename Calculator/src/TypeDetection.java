...
class TypeDetection {
    ...
    static Number parseAndValidate(String symbol) throws Exception {
        ...
        if (value < 1 || value > 10) {
            throw new Exception("Wrong number or numbers. Quiting...");
        }
    ...
    static Number parseAndValidate(String symbol, NumberType type) throws Exception {
        ...
        if (number.getType() != type) {
            throw new Exception("Use only Roman ar Arabic numbers ar the same time. Quiting...  ");
        }
    ...
    static int toArabicNumber(String roman) throws Exception {
        ...
        while (i < roman.length()) {
            ...
            if (num < 0) throw new Exception("Wrong Roman number. Quiting...");
